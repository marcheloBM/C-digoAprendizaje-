...
public class FrLogin extends javax.swing.JFrame {
    ...
    static ClUsuario clUsuario = null;
    ...
    public ClUsuario Validar() throws Exception{
        clUsuario =new ClUsuario(txtRut.getText(), String.valueOf(txtPass.getPassword()));
    ...
    private void initComponents() {
        ...
        imgLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cl/Login/IMG/Login.png"))); // NOI18N
    ...
    public void Tecnico(){
        FrTecnico tecnico=new FrTecnico();
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        try {
            ...
            if(!dAOUsuario.sqlSelectValidar(clUsuario)){
                ...
                String nomCompleto=clUsuario.getNombre();
